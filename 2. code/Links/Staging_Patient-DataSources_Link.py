...
col=['patientdatasources_link_key','loaddatetime','recordsource','patient_hub_key','datasources_hub_key']
df2 = pd.DataFrame(list1,columns=col)
df2.to_sql('patientdata_sources_link',con=engine,if_exists='append') #this writes the dataframe into the postgres database
