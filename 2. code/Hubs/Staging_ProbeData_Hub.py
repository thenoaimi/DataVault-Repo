...
for i in range(114040):
    ...
    list1.append(list)
col=['probedata_hub_key','probedata_businesskey','loaddatetime','recordsource']
df2 = pd.DataFrame(list1,columns=col)
df2.to_sql('probedata_hub',con=engine,if_exists='append') #this writes the dataframe into the postgres databas
