...
for i in range(53):
    ...
    list1.append(list)
col=['patient_hub_key','patient_businesskey','loaddatetime','recordsource']
df2 = pd.DataFrame(list1,columns=col)
df2.to_sql('patient_hub',con=engine,if_exists='append') #this writes the dataframe into the postgres databas
