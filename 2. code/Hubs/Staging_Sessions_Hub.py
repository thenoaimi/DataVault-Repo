...
for i in range(6):
    ...
    list1.append(list)
col=['sessions_hub_key','sessions_businesskey','loaddatetime','recordsource']
df2 = pd.DataFrame(list1,columns=col)
df2.to_sql('sessions_hub',con=engine,if_exists='append') #this writes the dataframe into the postgres databas
