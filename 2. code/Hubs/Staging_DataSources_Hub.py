...
for i in range(3):
    ...
    list.append(list3[i])
    list1.append(list)
col=['datasources_hub_key','datasources_businesskey','loaddatetime','recordsource','datasource_name']
df2 = pd.DataFrame(list1,columns=col)
df2.to_sql('datasources_hub',con=engine,if_exists='append') #this writes the dataframe into the postgres databas
